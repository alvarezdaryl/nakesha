...
<!-- HIDDEN COLOR CHANGER -->      
  	...
  	<!--LOGO-->
	<div class="grid_8" id="logo">Nakesha's Administration</div>
    <div class="grid_8">
<!-- USER TOOLS START -->
					...
					while($row = mysqli_fetch_array($rs))
						{
							...
							echo '<td><div align="center"><a rel="facebox" href="vieworders.php?id='.$row['confirmation'].'" title="Click To View Orders">View Orders</a> | <a rel="facebox" href="viewreport.php?id='.$row['confirmation'].'" title="Click To View Orders"></a> | <a rel="facebox" href="editstatus.php?id='.$row['reservation_id'].'">edit</a> | <a href="#" id="'.$row['reservation_id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
							echo '</tr>';
						}
					?> 
				</tbody>
