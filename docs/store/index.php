...
<div id="wrapper">
	<div id="note">
		<h1 style="margin-top: 0px; margin-bottom: 5px;"><center>Select Product</center></h1>
	</div>
	<div id="content">
		<div id="productlist">
			...
			$result = mysqli_query($l, "SELECT * FROM internet_shop");
		...
		<div id="orderlist">
			<table width="100%" border="1" cellpadding="2" cellspacing="2">
				<tr>
				  <td></td>
				  <td width="25"><div align="center"><strong>Quantity</strong></div></td>
				  <td width="150"><div align="left"><strong><center>Product</center></strong></div></td>
				  <td width="25"><div align="center"><strong>Total</strong></div></td>
				</tr>
				<?php
				$result3 = mysqli_query($l, "SELECT * FROM orders WHERE confirmation='$transnum'");
				...
				<tr>
				  ...
				  <td><div align="center">
				  <?php
				  $result5 = mysqli_query($l,"SELECT sum(total) FROM orders WHERE confirmation='$transnum'");
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<option value="2">Shipping Inside Alfonso</option>
				<option value="3">Shipping Outside Alfonso</option>
				</select></td>
			  </tr>
			  <tr style="">
...
<a href="#" class="tooltip">
    ...
    <span>
        <img class="callout" src="callout.gif" />
        <strong>Free Shipping Inside Alfonso</strong><br />
        <strong>Shipping + 500 Outside Alfonso</strong>
    </span>
</a>
	</div>
	<div class="clearfix"></div>
