...
jQuery(function($){
        ...
        $.supersized({
            ...
            slides 					:  	[			// Slideshow Images
                                                {image : 'images/12.jpg', title : '<h1>NAKESHAS SHOP</h1><br><h1>GOOD QUALITY ITEMS AT GOOD PRICE </h1> </p>',},
                                                {image : 'images/13.jpg', title : '<h1>SOFA SET</h1><br><h1>PRICE RANGE 16,500 - 20,500</h1></p>',},
												{image : 'images/14.jpg', title : '<h1>TABLE SET</h1><br><h1>PRICE RANGE 14,500 - 20,500</h1></p>',}
										],
