...
if($rrrrr==2){
echo 'Shipping Inside Alfonso';
}
if($rrrrr==3){
echo 'Shipping Outside Alfonso';
}
?>" />
...
echo '<input type="hidden" name="date" id="date" value="'.$NewDate.'" />';
?>

<h1>Personal Information form</h1>
<p>Note: This note inform/s you when you can receive your order<br>
Inside Alfonso: 10,000 above- 2 days | 10,000 below- 1 day<br>
Outside Alfonso: 10,000 above- 4 days | 10,000 below- 3 days<br>
</p>
